...
┴│☂︎ *ɴᴀᴍᴀ:* %name
${emot}│☂︎ *ᴛᴀɢ:* %tag
${emot}│☂︎ *ᴘʀᴇᴍɪᴜᴍ:* %prems
${emot}│☂︎ *ʟɪᴍɪᴛ:* %limit
${emot}│☂︎ *ᴍᴏɴᴇʏ:* %money
${emot}│☂︎ *ʀᴏʟᴇ:* %role
${emot}│☂︎ *ʟᴇᴠᴇʟ:* %level [ %xp4levelup Xp For Levelup]
${emot}│☂︎ *xᴘ:* %exp / %maxexp
┬│☂︎ *ᴛᴏᴛᴀʟ xᴘ:* %totalexp
│╰────────────────···
┠─────═[ 𝗛𝗮𝗿𝗶 𝗜𝗻𝗶 ]═─────⋆
│╭────────────────···
┴│    *${ucapan()} %name!*
${emot}│☂︎ *ᴛᴀɴɢɢᴀʟ:* %week %weton
${emot}│☂︎ *ᴅᴀᴛᴇ:* %date
${emot}│☂︎ *ᴛᴀɴɢɢᴀʟ ɪsʟᴀᴍ:* %dateIslamic
${emot}│☂︎ *ᴡɪʙ:* %wib
┬│☂︎ *ᴡᴀᴋʀᴜ:* %time
│╰────────────────···
┠─────═[ 𝗜𝗻𝗳𝗼 𝗕𝗼𝘁 ]═─────⋆
...
${emot}│☂︎ *ᴍᴏᴅᴇ:* %mode
${emot}│☂︎ *ᴘʀᴇғɪx:* [ *%_p* ]
${emot}│☂︎ *ʙᴀɪʟᴇʏs:* Multi Device
${emot}│☂︎ *ʙᴀᴛᴛᴇʀʏ:* ${conn.battery != undefined ? `${conn.battery.value}% ${conn.battery.live ? '🔌 pengisian' : ''}` : 'tidak diketahui'}
${emot}│☂︎ *ᴘᴋᴀᴛғʀᴏᴍ:* %platform
${emot}│☂︎ *ᴛʏᴘᴇ:* Node.Js
${emot}│☂︎ *ᴜᴘᴛɪᴍᴇ:* %muptime
┬│☂︎ *ᴅᴀᴛᴀʙᴀsᴇ:* %rtotalreg dari %totalreg
│╰────────────────···
╰──────────═┅═──────────

❏──「 *𝗜𝗻𝗳𝗼 𝗖𝗠𝗗* 」───❏
│ *%totalfeatures* ᴄᴏᴍᴍᴀɴᴅ
│ *Ⓟ* = ᴘʀᴇᴍɪᴜᴍ
│ *Ⓛ* = ʟɪᴍɪᴛ
❏────────────❏
`.trimStart(),
